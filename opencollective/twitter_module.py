...
writer_team.writerow(['UserName', 'Member Since', 'Bio', 'No of Followers', 'No of Tweets', 'Profile URL'])
...
for profile in all_profiles:
	try:
		if (api.get_user(profile)):
			...
			writer_team.writerow([user_name, user_cr_dt, user_desc, user_followers, user_tweets, user_url])
